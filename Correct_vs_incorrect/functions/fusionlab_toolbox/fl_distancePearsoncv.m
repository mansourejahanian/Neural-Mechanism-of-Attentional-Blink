function dist = fl_distancePearsoncv(data,condid,varargin)
...
for p = 1:numpermutation
    ...
    d = d + distancePearsoncv(traindata,testdata,method);
    if conditiongen
        d2 = d2 + distancePearsoncv(traindata,testdata2,method);
    end
